...
- **[Pintura con contenido más grande (LCP)](/lcp/)** : mide el rendimiento de *carga.* Para brindar una buena experiencia de usuario, LCP debe ocurrir dentro de los **2.5 segundos desde** que la página comienza a cargarse.
